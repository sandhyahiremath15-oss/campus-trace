  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: "Registration Failed",
        description: error.message || "Failed to create account. Check your details.",
      });
    } finally {
      setLoading(false);
    }
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-[#F1F5F9] p-4 font-body">
      ...
      <div className="flex flex-col items-center gap-4 mb-8">
        ...
        <div className="text-center">
          <h1 className="text-3xl font-black text-slate-800 font-headline mb-1">Join the Community</h1>
      ...
      <div className="w-full max-w-[440px] bg-white rounded-[24px] p-8 md:p-10 shadow-xl shadow-slate-200/60 border border-slate-100">
        <form onSubmit={handleEmailSignUp} className="space-y-5">
          ...
          <div className="space-y-2">
            <Label htmlFor="password" title="At least 6 characters" className="text-sm font-bold text-slate-700">Password</Label>
            <div className="relative">
          ...
          <Button 
            type="submit" 
            className="w-full h-14 rounded-xl bg-blue-600 text-white hover:bg-blue-700 text-lg font-bold shadow-lg shadow-blue-200 transition-all flex items-center justify-center gap-2 mt-2"
            disabled={loading}
          >
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-white px-4 text-slate-400 font-bold tracking-widest">OR REGISTER WITH</span>
            </div>
          </div>
